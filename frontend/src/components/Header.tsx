      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <Link to="/" className="flex items-center space-x-3 group">
            <div className="bg-gradient-to-br from-primary to-accent p-2 rounded-lg shadow-vibrant group-hover:shadow-glow transition-all">
              <Zap className="h-6 w-6 text-white" />
            </div>
            <div>
              <h1 className="text-xl font-bold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">NSO</h1>
          ...
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <Link to="/dispatch" className="text-secondary hover:text-primary transition-colors font-medium">
              Dispatch
            </Link>
          </nav>
